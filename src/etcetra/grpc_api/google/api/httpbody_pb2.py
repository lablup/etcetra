...
_descriptor_pool.Default()._internal_db._file_desc_protos_by_file['google/api/httpbody.proto'] = DESCRIPTOR
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HTTPBODY._serialized_start=57
  _HTTPBODY._serialized_end=145
